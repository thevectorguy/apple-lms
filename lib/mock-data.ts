...
export const notifications: AppNotification[] = [
  {
    id: 'notif-1',
    title: 'Apple Intelligence walkthrough is ready',
    message: 'A short launch guide is now available with the recommended flow for showing Writing Tools and moving naturally into a live demo.',
    timeLabel: '5 min ago',
    contextLabel: 'Apple Partner Academy',
  ...
  {
    id: 'notif-2',
    title: 'Your next practice session is ready',
    message: 'Nova prepared a short A18 Pro refresher to help strengthen technical confidence before your next customer conversation.',
    timeLabel: '18 min ago',
    contextLabel: 'Nova Coach',
    category: 'practice',
    tone: 'violet',
    unread: true,
  },
  {
    id: 'notif-3',
    title: 'One more lesson keeps your streak going',
    message: 'Complete one lesson today to continue your 4-day streak and keep your daily momentum moving forward.',
    timeLabel: '42 min ago',
    contextLabel: 'Daily momentum',
    category: 'streak',
    tone: 'amber',
    unread: true,
  },
  {
    id: 'notif-4',
    title: 'A new iPhone 16 Pro module is available',
    message: 'The next section on pro camera workflows has been unlocked and is ready when you are.',
    timeLabel: 'Yesterday',
    contextLabel: 'Series update',
    category: 'course',
    tone: 'emerald',
    unread: false,
  },
  {
    id: 'notif-5',
    title: 'This week\'s team briefing has been added',
    message: 'Retail talking points and launch-floor priorities are now available in the announcement feed for quick reference.',
    timeLabel: 'Yesterday',
    contextLabel: 'Team briefing',
    category: 'announcement',
    tone: 'sky',
    unread: false,
  },
...
export const practiceSessionHistory: PracticeSessionHistoryEntry[] = [
  {
    id: 'nova-session-1',
    scenarioName: 'MacBook Pro performance discovery',
    reportLine: 'More deliberate questions helped the conversation feel steadier before the recommendation landed.',
    score: 84,
    completedAt: 'Today, 3:40 PM',
    durationLabel: '5 min',
    focusLabel: 'Plan to Probe',
    xpEarned: 60,
    speedStages: {
      start_right: { score: 84, sourceTitle: 'MacBook Pro performance discovery' },
      plan_to_probe: { score: 76, sourceTitle: 'MacBook Pro performance discovery' },
      explain_value: { score: 89, sourceTitle: 'MacBook Pro performance discovery' },
      eliminate_objection: { score: 81, sourceTitle: 'MacBook Pro performance discovery' },
      drive_closure: { score: 86, sourceTitle: 'MacBook Pro performance discovery' },
    },
    report: {
      headline: 'The probing felt more deliberate by the end.',
      summary: 'You uncovered the customer performance need more clearly and stopped rushing the recommendation once Nova pushed for a calmer flow.',
      strengths: [
        'Opened with broader discovery instead of jumping into specs.',
        'Stayed with the customer workflow long enough to uncover the real need.',
        'Moved into the recommendation with better context.',
      ],
      improvements: [
        'Pause a little longer after each answer before moving on.',
        'Reflect the customer need back more directly before recommending.',
        'Let one clearer probe land before shifting into the solution.',
      ],
    },
  },
  {
    id: 'nova-session-2',
    scenarioName: 'Price objection on iPhone 16 Pro',
    reportLine: 'You stayed calm through pushback and reframed value well, but the final close could be firmer.',
    score: 84,
    completedAt: 'Yesterday, 6:15 PM',
    durationLabel: '4 min',
    focusLabel: 'Communication',
    xpEarned: 60,
    speedStages: {
      start_right: { score: 78, sourceTitle: 'Price objection on iPhone 16 Pro' },
      plan_to_probe: { score: 72, sourceTitle: 'Price objection on iPhone 16 Pro' },
      explain_value: { score: 84, sourceTitle: 'Price objection on iPhone 16 Pro' },
      eliminate_objection: { score: 88, sourceTitle: 'Price objection on iPhone 16 Pro' },
      drive_closure: { score: 74, sourceTitle: 'Price objection on iPhone 16 Pro' },
    },
    report: {
      headline: 'Good objection handling with room to close harder.',
      summary: 'The empathy and value framing worked, especially once you stopped defending the price and started linking it back to customer payoff.',
      strengths: [
        'Acknowledged the concern without getting defensive.',
        'Reframed the price around value and longevity.',
        'Kept the conversation moving instead of stalling in the objection.',
      ],
      improvements: [
        'Shorten the response after the reframe.',
        'Bring in one quick proof example sooner.',
        'Finish with a more direct closing question.',
      ],
    },
  },
  {
    id: 'nova-session-3',
    scenarioName: 'Discovery questions for a switcher customer',
    reportLine: 'The questions were more focused this time and the conversation uncovered real needs faster.',
    score: 81,
    completedAt: 'Jun 3, 11:10 AM',
    durationLabel: '6 min',
    focusLabel: 'Plan to Probe',
    xpEarned: 60,
    speedStages: {
      start_right: { score: 73, sourceTitle: 'Discovery questions for a switcher customer' },
      plan_to_probe: { score: 87, sourceTitle: 'Discovery questions for a switcher customer' },
      explain_value: { score: 76, sourceTitle: 'Discovery questions for a switcher customer' },
      eliminate_objection: { score: 68, sourceTitle: 'Discovery questions for a switcher customer' },
      drive_closure: { score: 70, sourceTitle: 'Discovery questions for a switcher customer' },
    },
    report: {
      headline: 'The probing structure is getting more deliberate.',
      summary: 'You made better use of open questions and listened long enough to uncover priorities before jumping into product recommendations.',
      strengths: [
        'Used open questions that invited real detail.',
        'Stayed with the customer need before pitching.',
        'Recovered well when the conversation drifted.',
      ],
      improvements: [
        'Ask one less question at the start to reduce overload.',
        'Reflect back the need more explicitly before moving on.',
        'Tie the final recommendation to the stated use case more tightly.',
      ],
    },
  },
  {
    id: 'nova-session-4',
    scenarioName: 'Team feedback after a missed launch task',
    reportLine: 'Clearer ownership language helped, though the checkpoint could still sound more decisive.',
    score: 79,
    completedAt: 'Jun 1, 4:25 PM',
    durationLabel: '5 min',
    focusLabel: 'Leadership',
    xpEarned: 60,
    speedStages: {
      start_right: { score: 75, sourceTitle: 'Team feedback after a missed launch task' },
      plan_to_probe: { score: 74, sourceTitle: 'Team feedback after a missed launch task' },
      explain_value: { score: 71, sourceTitle: 'Team feedback after a missed launch task' },
      eliminate_objection: { score: 80, sourceTitle: 'Team feedback after a missed launch task' },
      drive_closure: { score: 77, sourceTitle: 'Team feedback after a missed launch task' },
    },
    report: {
      headline: 'The feedback landed, but the follow-through needs more edge.',
      summary: 'You handled the coaching tone well and made the missed task feel actionable instead of personal, which kept the conversation constructive.',
      strengths: [
        'Named the issue directly without sounding harsh.',
        'Focused on behavior and ownership instead of blame.',
        'Kept the tone steady through the difficult part.',
      ],
      improvements: [
        'Set the next checkpoint more explicitly.',
        'State the expected standard a little earlier.',
        'Close with firmer accountability language.',
      ],
    },
  },
  {
    id: 'nova-session-5',
    scenarioName: 'Apple Watch fitness comparison',
    reportLine: 'The recommendation got clearer once the lifestyle use case came forward.',
    score: 83,
    ...
    speedStages: {
      ...
      plan_to_probe: { score: 70, sourceTitle: 'Apple Watch fitness comparison' },
      explain_value: { score: 86, sourceTitle: 'Apple Watch fitness comparison' },
      eliminate_objection: { score: 74, sourceTitle: 'Apple Watch fitness comparison' },
      drive_closure: { score: 80, sourceTitle: 'Apple Watch fitness comparison' },
    },
    report: {
      headline: 'A cleaner comparison made the pitch easier to trust.',
      summary: 'You improved once the answer shifted from feature listing into a simpler use-case recommendation tied to how the customer actually trains.',
      strengths: [
        'Moved the comparison into everyday customer language.',
        'Recommended a model with more confidence near the end.',
        'Kept the answer focused on one buying context.',
      ],
      improvements: [
        'Mention the deciding factor earlier.',
        'Use one stronger health or fitness proof point.',
        'Shorten the setup before the recommendation lands.',
      ],
    },
  },
  {
    id: 'nova-session-6',
    scenarioName: 'Compliance response to data-sharing request',
    reportLine: 'Safe boundaries were clear and the alternative path was explained better this time.',
    score: 86,
    completedAt: 'May 27, 10:20 AM',
    durationLabel: '5 min',
    focusLabel: 'Compliance',
    xpEarned: 60,
    speedStages: {
      start_right: { score: 82, sourceTitle: 'Compliance response to data-sharing request' },
      plan_to_probe: { score: 69, sourceTitle: 'Compliance response to data-sharing request' },
      explain_value: { score: 83, sourceTitle: 'Compliance response to data-sharing request' },
      eliminate_objection: { score: 85, sourceTitle: 'Compliance response to data-sharing request' },
      drive_closure: { score: 78, sourceTitle: 'Compliance response to data-sharing request' },
    },
    report: {
      headline: 'The answer stayed safe without sounding rigid.',
      summary: 'You set the compliance line early, explained the reasoning in plain language, and did a better job offering the next safe option instead of ending abruptly.',
      strengths: [
        'Named the boundary clearly and early.',
        'Explained the policy reason in simpler terms.',
        'Offered a usable next step after the no.',
      ],
      improvements: [
        'Sound firmer in the first sentence.',
        'Reduce repetition once the safe answer is set.',
        'Close with a more confident transition to the alternative.',
      ],
    },
  },
]
...
export const sampleAssessment: Assessment = {
  ...
  xpReward: 100,
  timeLimit: 300,
  badgeReward: { id: '3', name: 'iPhone Pro Course', icon: '📱', description: 'Master all iPhone courses', locked: true },
  questions: [
    {
      id: '1',
...
export const sharedAchievements: Achievement[] = [
  ...
  },
  {
    id: '3',
    title: 'iPhone Pro',
    description: 'Mastered all iPhone courses',
    icon: '📱',
    xp: 400,
